...
export default function Profissionais() {
  ...
  return (
    <PageLayout
      ...
      subtitle="Gestão completa da equipe"
      onFabClick={handleNewProfissional}
        ...
        {profissionais.length > 0 && (
          <div className="flex justify-between items-center bg-card border rounded-lg p-4">
            <div className="relative flex-1 max-w-md">
              ...
              <Input
                placeholder={t.placeholders.searchProfessionals}
                value={searchTerm}
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <Badge variant="secondary" className="bg-[hsl(var(--professionals-color))]/10 text-[hsl(var(--professionals-color))]">
                  {filteredProfissionais.length} Membros
                </Badge>
              </div>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <Card className="border-dashed">
              <CardContent className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">Nenhum membro da equipe ainda</h3>
                <p className="text-muted-foreground mb-6">Comece adicionando seu primeiro profissional</p>
                <Button 
                ...
                >
                  ...
                  {t.actions.add} Primeiro Profissional
                </Button>
              </CardContent>
            </Card>
          ) : (
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-[hsl(var(--professionals-color))] font-medium">
                          {profissional.percentual_comissao}% Comissão
                        </span>
                      </div>
