    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-[hsl(var(--services-color))] rounded-lg flex items-center justify-center">
            <Scissors className="w-6 h-6 text-white" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-foreground">Services</h1>
            <p className="text-muted-foreground">Catálogo completo de serviços</p>
          </div>
        </div>
        <Button 
        ...
        <div className="flex justify-between items-center bg-card border rounded-lg p-4">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <Badge variant="secondary" className="bg-[hsl(var(--services-color))]/10 text-[hsl(var(--services-color))]">
              {filteredServicos.length} Services
            </Badge>
          </div>
        </div>
      )}
          ...
          Object.entries(servicosFiltradosPorCategoria).map(([categoria, servicosCategoria]) => (
            <div key={categoria} className="space-y-4">
              ...
              <div className="flex items-center gap-3 pb-2 border-b">
                ...
                >
                  {servicosCategoria.length} {servicosCategoria.length === 1 ? 'service' : 'services'}
                </Badge>
              </div>
